                    ...
                    _.each(childNodes, function (child) {
                       ...
                       var root_node_select =  "root_"+treeNode.subtask_project_id[0]+"_"+treeNode.subtask_project_id[1];
                        ...
                        if (root_node_select  === node.zt_id){
                            ...
                            // rows_to_gantt.push(_.find(targetNode.widget_parent.rows_to_gantt, function(item) { return item.id === child.id }))
                            // console.log("indx: "+child.getIndex()+", level: "+ child.level  +", name: "+child.value_name )
                        }
                ...
                if (match_task){
                    ...
                    var task_model = parent.state.modelName;
                     ...
                     parent._rpc({
                        ...
                        .then(function(ev) {
                            parent.trigger_up('notification', {
                                title: _t('Tree Data Update'),
                                message: _t('Data updated : ') + ev
                            });
                     });
                 ...
                 _.each(nodes, function (node) {
                    ...
                    if (typeof(node["fold"]) != 'undefined' && node["fold"] != null) {
                     ...
                     _.each(childNodes, function (child, index) {
                        ...
                        // aObj.on('mouseover', this.proxy('hover_add'));
                        // aObj.on('mouseout', this.proxy('hover_remove'));
